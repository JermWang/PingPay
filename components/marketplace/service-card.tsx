...
export function ServiceCard({ service, showCreator = true }: ServiceCardProps) {
  ...
  return (
    <div className="group relative">
      ...
      <div className="absolute -inset-0.5 bg-gradient-to-r from-[#00F9FF] to-[#6DDCFF] rounded-2xl opacity-0 group-hover:opacity-20 blur transition duration-500" />
      
      <GlassPanel className="relative p-6 glass-hover reflective-overlay transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-[#00F9FF]/15 h-full flex flex-col">
        ...
        <div className="flex items-start justify-between mb-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {service.verified && (
              <div className="flex items-center gap-1 bg-[#00F9FF]/15 text-[#00F9FF] px-2.5 py-1 rounded-full text-xs font-medium border border-[#00F9FF]/30">
                <Shield className="w-3 h-3" />
                <span>Verified</span>
              </div>
            )}
            {service.featured && (
              <div className="flex items-center gap-1 bg-[#00F9FF]/10 text-[#9AFFEF] px-2.5 py-1 rounded-full text-xs font-medium border border-[#00F9FF]/20">
          ...
          <div className="flex flex-col items-end gap-1">
            <div className="flex items-baseline gap-1">
              <span className="text-2xl font-bold bg-gradient-to-r from-[#00F9FF] to-[#6DDCFF] bg-clip-text text-transparent">
        ...
        <h3 className="font-bold text-xl mb-2 text-white group-hover:text-[#00F9FF] transition-colors">
          {service.name}
        </h3>
        ...
        {showCreator && creator && (
          <Link
            ...
            className="flex items-center gap-2 text-xs text-gray-400 hover:text-[#00F9FF] transition-colors mb-4 group/creator"
          >
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-[#00F9FF] to-[#6DDCFF] flex items-center justify-center group-hover/creator:scale-110 transition-transform">
        ...
        <div className="bg-black/30 rounded-lg p-3 mb-4 flex items-center justify-between border border-white/5">
          ...
          <Button
            ...
            size="icon"
            onClick={handleCopy}
            className="h-7 w-7 p-0 text-gray-400 hover:text-[#00F9FF] hover:bg-white/5 flex-shrink-0"
          >
            {copied ? (
